...
function jpm.particles.init()
	...
	jpm.particles.fire1:setLinearAcceleration(100, 100, 200, 200)
	...
	jpm.particles.fire1:setEmitterLifetime(0.1)
	jpm.particles.fire1:setParticleLifetime(0.5)
	...
	jpm.particles.fire2:setLinearAcceleration(100, 100, 200, 200)
	...
	jpm.particles.fire2:setEmitterLifetime(0.1)
	jpm.particles.fire2:setParticleLifetime(0.5)
